...
public:
    ...
    SnakeGame(int width, int height, vector<pair<int, int>> food): food(food) {
        this->width = width;
        this->height = height;
        score = 0;
        snake.push_back({0, 0});
    ...
    bool gotPoint(pair<int, int>& head){
